...
mixin _$TaskEntity {
  ...
  get getIdQuery => QueryModel(name: 'id', value: this.id.toString());
}
...
abstract class $TaskEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String title, String description, bool done});
}
...
class __$$_TaskModelCopyWithImpl<$Res>
    extends _$TaskEntityCopyWithImpl<$Res, _$_TaskModel>
...
class _$_TaskModel implements _TaskModel {
  ...
  @override
  String toString() {
    return 'TaskEntity(id: $id, title: $title, description: $description, done: $done)';
  }
...
abstract class _TaskModel implements TaskEntity {
  factory _TaskModel(
      {required final int id,
      required final String title,
      required final String description,
      final bool done}) = _$_TaskModel;
